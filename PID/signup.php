...
if (isset($_POST["btnOK1"]))
{
  ...
  echo "<script>alert('註冊失敗（兩次密碼需輸入一樣）');</script>";
...
<form align="center" method = "post">
        ...
        <td align="left" valign="baseline" bgcolor="FFD382" colspan="2">個人資料</td>
            ...
            <td width="220" valign="baseline"><input type="text" name="txtUserName1" id="txtUserName1" size="30" required/></td>
            </tr>

            <tr>
            <td width="150" align="left" valign="baseline"> <font face="link" color="#17160D" size="4">．會員帳號</font></td>
            <td width="220" valign="baseline" ><input type="text" name="txtUserName2" id="txtUserName2" size="30" required/></td>
            </tr>


            <tr>
            <td width="150" align="left" valign="baseline"> <font face="link" color="#17160D" size="4">．會員密碼</font></td>
            <td width="220" valign="baseline"><input type="password" name="txtPassword1" id="txtPassword1" size="30" required/></td>
            </tr>


            <tr>
            <td width="150" align="left" valign="baseline"> <font face="link" color="#17160D" size="4">．再次輸入密碼</font></td>
            <td width="220" valign="baseline"><input type="password" name="txtPassword2" id="txtPassword2" size="30" required/></td>
            </tr>
            ...
            <td width="220" valign="baseline"><input type="text" name="txtUserName4" id="txtUserName4" size="30" required/></td>
            </tr>


            <tr>
            <td width="150" align="left" valign="baseline"> <font face="link" color="#17160D" size="4">．聯絡電話</font></td>
            <td width="220" valign="baseline"><input type="text" name="txtUserName5" id="txtUserName5" size="30" required/></td>
            </tr>


            <tr>
            <td width="150" align="left" valign="baseline"> <font face="link" color="#17160D" size="4">．通訊地址</font></td>
            <td width="220" valign="baseline"><input type="text" name="txtUserName6" id="txtUserName6" size="30" required/></td>
            </tr>
            ...
            <tr>
                ...
                <input type="button" name="btnHome" id="btnHome" value="回首頁" onclick="window.location='index.php'"/>
            </td>
    </tr>
</form>
